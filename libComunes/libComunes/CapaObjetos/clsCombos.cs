        ...
        #region "Metodos"
            public bool LlenarComboWeb()
            {
                if (Validar())
                {
                    ...
                    clsConexionDB objConexionBD = new clsConexionDB();

                    objConexionBD.NombreTabla = strNombreTabla;
                    objConexionBD.SQL = strSQL;
                    if (objConexionBD.LlenarDataSet())
                    {
                        objcboGenericoWeb.DataSource = objConexionBD.MiDataSet.Tables[strNombreTabla];
            ...
            public bool LlenarCombo()
            {
                if (Validar())
                {
                    ...
                    if (objConexionBD.LlenarDataSet())
                    {
                        cboGenerico.DataSource = objConexionBD.MiDataSet.Tables[strNombreTabla];
